...
class TestTensorTransformationCliqueExpansion(unittest.TestCase):
    ...
    def test_dense_tensor_transformation_clique_expansion(self):
        logger.info("START: test_dense_tensor_transformation_clique_expansion")
        #
        ...
        #
        logger.info("END: test_dense_tensor_transformation_clique_expansion")

    def test_dense_10_tensor_transformation_clique_expansion(self):
        logger.info("START: test_dense_tensor_transformation_clique_expansion")
        #
        _n = 10
        _e = 10
    ...
    def test_dense_100_tensor_transformation_clique_expansion(self):
        logger.info("START: test_dense_tensor_transformation_clique_expansion")
        #
        _n = 100
        _e = 100
    ...
    def test_dense_100v_10e_tensor_transformation_clique_expansion(self):
        logger.info("START: test_dense_tensor_transformation_clique_expansion")
        #
        _n = 100
        _e = 10
